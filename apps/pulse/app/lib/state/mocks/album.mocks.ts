...
export const meteoraAlbumMock = {
  ...
  cover: {
    imageUrl: "https://upload.wikimedia.org/wikipedia/pt/thumb/8/83/Linkin_park-meteora_a.jpg/250px-Linkin_park-meteora_a.jpg",
  },
  artist: artistMock,
} satisfies Album;
...
export const aThousandSunsAlbumMock = {
  ...
  cover: {
    imageUrl: "https://upload.wikimedia.org/wikipedia/en/a/af/A_Thousand_Suns_Cover2.jpg",
  },
  artist: artistMock,
} satisfies Album;
...
export const theHuntingPartyAlbumMock = {
  ...
  cover: {
    imageUrl: "https://upload.wikimedia.org/wikipedia/en/f/fa/Linkin_Park%2C_The_Hunting_Party%2C_album_art_final.jpg",
  },
  artist: artistMock,
} satisfies Album;
...
export const oneMoreLightAlbumMock = {
  ...
  cover: {
    imageUrl: "https://upload.wikimedia.org/wikipedia/en/b/b2/Linkin_Park%2C_One_More_Light%2C_album_art_final.jpeg",
  },
  artist: artistMock,
} satisfies Album;
